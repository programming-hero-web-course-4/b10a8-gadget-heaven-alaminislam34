  ...
  return (
    <div>
      <form className="flex flex-col gap-4 md:gap-6 p-4 md:p-6 rounded-xl bg-[#9538e2]/20 backdrop-blur-xl md:w-8/12 lg:w-6/12 mx-auto">
        ...
        <input
          className="py-1.5 md:py-2 pl-4 rounded-md"
          type="text"
          name="name"
        ...
        />
        <input
          className="py-1.5 md:py-2 pl-4 rounded-md bg-white hover:bg-base-300 text-base md:text-lg font-bold text-purple-600"
          type="submit"
          name="Login"
        />
        <p className="flex flex-row gap-2 justify-center items-center text-black">
